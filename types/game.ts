...
export type ClientMessage =
  ...
  | { type: "capture_guess"; guess: LatLng; countryCode?: string; playerId?: string; roundNumber: number; locationId: string; roundStartedAt: number; roundEndsAt: number | null }
...
export type ServerMessage =
  | { type: "hello"; playerId: string; resumeToken: string }
